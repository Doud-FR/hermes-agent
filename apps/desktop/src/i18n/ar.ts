...
export const ar = defineLocale({
  ...
  messaging: {
    ...
    richHtmlEmail: 'بريد إلكتروني بتنسيق HTML غني',
    richHtmlEmailHelp: 'عرض Markdown الصادر كـ HTML منقّى مع نسخة احتياطية بنص عادي.',
    emailSignature: 'التوقيع',
    emailSignatureHelp: 'إضافة التوقيع المضبوط مرة واحدة إلى كل بريد إلكتروني صادر.',
    emailSignatureText: 'نص التوقيع',
    emailSignatureTextHelp: 'النسخة الاحتياطية الأساسية بالنص العادي. مطلوبة عند تفعيل التوقيع.',
    emailSignatureTextPlaceholder: 'أدخل توقيع النص العادي',
    emailSignatureTextRequired: 'نص التوقيع مطلوب عند تفعيل التوقيع.',
    emailSignatureHtml: 'HTML متقدم للتوقيع',
    emailSignatureHtmlHelp: 'HTML منقّى اختياري. اتركه فارغا لإنشائه من نص التوقيع.',
    emailSignatureHtmlPlaceholder: '<strong>توقيع HTML اختياري</strong>',
    emailSignatureLogo: 'شعار التوقيع',
    emailSignatureLogoHelp:
      'يُستخدم فقط عند تفعيل البريد بتنسيق HTML المنسق والتوقيع، وعندما يحتوي HTML التوقيع على {{email_signature_logo}}.',
    emailSignatureLogoFormats: 'PNG أو JPEG أو GIF أو WebP. الحد الأقصى للحجم: 2 MiB.',
    emailSignatureLogoLoading: 'جارٍ تحميل شعار التوقيع…',
    emailSignatureLogoNone: 'لم يتم إعداد شعار للتوقيع.',
    emailSignatureLogoConfigured: 'تم إعداد شعار التوقيع.',
    emailSignatureLogoInvalidStored: 'شعار التوقيع المُعد غير صالح. استبدله أو أزله.',
    emailSignatureLogoFile: 'ملف شعار التوقيع',
    emailSignatureLogoChoose: 'اختيار شعار',
    emailSignatureLogoReplace: 'استبدال الشعار',
    emailSignatureLogoUploading: 'جارٍ الرفع…',
    emailSignatureLogoUploaded: 'تم رفع شعار التوقيع.',
    emailSignatureLogoRemove: 'إزالة الشعار',
    emailSignatureLogoRemoving: 'جارٍ الإزالة…',
    emailSignatureLogoRemoved: 'تمت إزالة شعار التوقيع.',
    emailSignatureLogoRemoveTitle: 'إزالة شعار التوقيع',
    emailSignatureLogoRemoveDescription: 'سيؤدي هذا إلى إزالة الشعار من هذا الملف الشخصي دون تغيير نص التوقيع أو HTML.',
    emailSignatureLogoUnsupported: 'تتطلب شعارات التوقيع إصدارًا أحدث من خادم Hermes.',
    emailSignatureLogoTooLarge: 'يجب ألا يتجاوز حجم الشعار 2 MiB.',
    emailSignatureLogoInvalidType: 'اختر صورة PNG أو JPEG أو GIF أو WebP.',
    emailSignatureLogoBackendInvalid: 'رفض الخادم هذه الصورة. اختر ملف PNG أو JPEG أو GIF أو WebP صالحًا.',
    emailSignatureLogoProfileNotFound: 'لم يتم العثور على الملف الشخصي المحدد.',
    emailSignatureLogoRemoteUploadUnsupported: 'رفع الملفات غير مدعوم بعد مع الخوادم البعيدة المحمية بـ OAuth.',
    emailSignatureLogoFailed: 'تعذر تحديث شعار التوقيع.',
    emailPreview: 'معاينة البريد الإلكتروني',
    emailPreviewHelp: 'اعرض معاينة آمنة باستخدام إعدادات HTML والتوقيع الحالية غير المحفوظة.',
    emailPreviewBody: 'رسالة نموذجية',
    emailPreviewBodyHelp: 'أدخل Markdown للمعاينة. لن يتم إرسال أي شيء.',
    emailPreviewBodyDefault: 'مرحبًا **بك**.\n\nهذه معاينة للبريد الإلكتروني.',
    emailPreviewGenerate: 'إنشاء المعاينة',
    emailPreviewGenerating: 'جارٍ الإنشاء…',
    emailPreviewUnsupported: 'تتطلب معاينة البريد الإلكتروني إصدارًا أحدث من خادم Hermes.',
    emailPreviewFailed: 'تعذر إنشاء معاينة البريد الإلكتروني.',
    emailPreviewFrameTitle: 'معاينة البريد الإلكتروني المعروضة',
    emailPreviewPlainFallback: 'النسخة الاحتياطية بالنص العادي',
    enabled: 'مفعل',
    disabled: 'معطل',

...
export const fr: Translations = {
  ...
  messaging: {
    ...
    richHtmlEmail: 'E-mail HTML enrichi',
    richHtmlEmailHelp: 'Afficher le Markdown sortant sous forme de HTML assaini avec un fallback en texte brut.',
    emailSignature: 'Signature',
    emailSignatureHelp: 'Ajouter une seule fois la signature configurée à chaque e-mail sortant.',
    emailSignatureText: 'Texte de la signature',
    emailSignatureTextHelp: 'Fallback canonique en texte brut. Requis lorsque la signature est activée.',
    emailSignatureTextPlaceholder: 'Saisissez la signature en texte brut',
    emailSignatureTextRequired: 'Le texte de la signature est requis lorsque la signature est activée.',
    emailSignatureHtml: 'HTML avancé de la signature',
    emailSignatureHtmlHelp: 'HTML assaini facultatif. Laissez vide pour le générer à partir du texte de la signature.',
    emailSignatureHtmlPlaceholder: '<strong>Signature HTML facultative</strong>',
    emailSignatureLogo: 'Logo de la signature',
    emailSignatureLogoHelp:
      "Utilisé uniquement lorsque l'e-mail HTML enrichi et la signature sont activés, et que le HTML de la signature contient {{email_signature_logo}}.",
    emailSignatureLogoFormats: 'PNG, JPEG, GIF ou WebP. Taille maximale : 2 Mio.',
    emailSignatureLogoLoading: 'Chargement du logo de la signature…',
    emailSignatureLogoNone: 'Aucun logo de signature configuré.',
    emailSignatureLogoConfigured: 'Logo de signature configuré.',
    emailSignatureLogoInvalidStored: 'Le logo de signature configuré est invalide. Remplacez-le ou supprimez-le.',
    emailSignatureLogoFile: 'Fichier du logo de la signature',
    emailSignatureLogoChoose: 'Choisir un logo',
    emailSignatureLogoReplace: 'Remplacer le logo',
    emailSignatureLogoUploading: 'Téléversement…',
    emailSignatureLogoUploaded: 'Logo de signature téléversé.',
    emailSignatureLogoRemove: 'Supprimer le logo',
    emailSignatureLogoRemoving: 'Suppression…',
    emailSignatureLogoRemoved: 'Logo de signature supprimé.',
    emailSignatureLogoRemoveTitle: 'Supprimer le logo de la signature',
    emailSignatureLogoRemoveDescription:
      'Cette action supprime le logo de ce profil. Le texte et le HTML de la signature ne sont pas modifiés.',
    emailSignatureLogoUnsupported: 'Les logos de signature nécessitent un backend Hermes plus récent.',
    emailSignatureLogoTooLarge: 'Le logo doit avoir une taille maximale de 2 Mio.',
    emailSignatureLogoInvalidType: 'Choisissez une image PNG, JPEG, GIF ou WebP.',
    emailSignatureLogoBackendInvalid:
      'Le backend a refusé cette image. Choisissez un fichier PNG, JPEG, GIF ou WebP valide.',
    emailSignatureLogoProfileNotFound: 'Le profil sélectionné est introuvable.',
    emailSignatureLogoRemoteUploadUnsupported:
      "Le téléversement de fichiers n'est pas encore pris en charge avec les backends distants protégés par OAuth.",
    emailSignatureLogoFailed: 'Impossible de mettre à jour le logo de la signature.',
    emailPreview: "Aperçu de l'e-mail",
    emailPreviewHelp: 'Générer un aperçu sécurisé avec les paramètres HTML et de signature actuels non enregistrés.',
    emailPreviewBody: 'Message exemple',
    emailPreviewBodyHelp: "Saisissez du Markdown à prévisualiser. Aucun message n'est envoyé.",
    emailPreviewBodyDefault: "Bonjour **à vous**.\n\nCeci est un aperçu d'e-mail.",
    emailPreviewGenerate: "Générer l'aperçu",
    emailPreviewGenerating: 'Génération…',
    emailPreviewUnsupported: "L'aperçu des e-mails nécessite un backend Hermes plus récent.",
    emailPreviewFailed: "Impossible de générer l'aperçu de l'e-mail.",
    emailPreviewFrameTitle: "Aperçu de l'e-mail généré",
    emailPreviewPlainFallback: 'Fallback en texte brut',
    enabled: 'Activé',
    disabled: 'Désactivé',

...
export const zhHant = defineLocale({
  ...
  messaging: {
    ...
    emailContent: '郵件內容',
    richHtmlEmail: '豐富 HTML 郵件',
    richHtmlEmailHelp: '將送出的 Markdown 轉譯為經過清理的 HTML，並保留純文字備用內容。',
    emailSignature: '簽名',
    emailSignatureHelp: '在每封送出的郵件中僅附加一次已設定的簽名。',
    emailSignatureText: '簽名文字',
    emailSignatureTextHelp: '標準純文字備用內容。啟用簽名時必填。',
    emailSignatureTextPlaceholder: '輸入純文字簽名',
    emailSignatureTextRequired: '啟用簽名時必須填寫簽名文字。',
    emailSignatureHtml: '進階簽名 HTML',
    emailSignatureHtmlHelp: '選填的已清理 HTML。留空時會從簽名文字產生。',
    emailSignatureHtmlPlaceholder: '<strong>選填 HTML 簽名</strong>',
    emailSignatureLogo: '簽名標誌',
    emailSignatureLogoHelp: '僅在啟用豐富 HTML 郵件與簽名，且簽名 HTML 包含 {{email_signature_logo}} 時使用。',
    emailSignatureLogoFormats: 'PNG、JPEG、GIF 或 WebP。大小上限：2 MiB。',
    emailSignatureLogoLoading: '正在載入簽名標誌…',
    emailSignatureLogoNone: '尚未設定簽名標誌。',
    emailSignatureLogoConfigured: '已設定簽名標誌。',
    emailSignatureLogoInvalidStored: '已設定的簽名標誌無效。請取代或移除。',
    emailSignatureLogoFile: '簽名標誌檔案',
    emailSignatureLogoChoose: '選擇標誌',
    emailSignatureLogoReplace: '取代標誌',
    emailSignatureLogoUploading: '正在上傳…',
    emailSignatureLogoUploaded: '簽名標誌已上傳。',
    emailSignatureLogoRemove: '移除標誌',
    emailSignatureLogoRemoving: '正在移除…',
    emailSignatureLogoRemoved: '簽名標誌已移除。',
    emailSignatureLogoRemoveTitle: '移除簽名標誌',
    emailSignatureLogoRemoveDescription: '這會從此設定檔移除標誌。簽名文字與 HTML 不會變更。',
    emailSignatureLogoUnsupported: '簽名標誌需要較新版本的 Hermes 後端。',
    emailSignatureLogoTooLarge: '標誌大小不得超過 2 MiB。',
    emailSignatureLogoInvalidType: '請選擇 PNG、JPEG、GIF 或 WebP 圖片。',
    emailSignatureLogoBackendInvalid: '後端拒絕了此圖片。請選擇有效的 PNG、JPEG、GIF 或 WebP 檔案。',
    emailSignatureLogoProfileNotFound: '找不到所選設定檔。',
    emailSignatureLogoRemoteUploadUnsupported: '目前不支援向受 OAuth 保護的遠端後端上傳檔案。',
    emailSignatureLogoFailed: '無法更新簽名標誌。',
    emailPreview: '郵件預覽',
    emailPreviewHelp: '使用目前未儲存的 HTML 與簽名設定產生安全預覽。',
    emailPreviewBody: '範例訊息',
    emailPreviewBodyHelp: '輸入要預覽的 Markdown。不會傳送任何內容。',
    emailPreviewBodyDefault: '**你好**。\n\n這是郵件預覽。',
    emailPreviewGenerate: '產生預覽',
    emailPreviewGenerating: '正在產生…',
    emailPreviewUnsupported: '郵件預覽需要較新版本的 Hermes 後端。',
    emailPreviewFailed: '無法產生郵件預覽。',
    emailPreviewFrameTitle: '已轉譯的郵件預覽',
    emailPreviewPlainFallback: '純文字備用內容',
    enabled: '已啟用',
    disabled: '已停用',

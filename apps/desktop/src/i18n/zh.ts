...
export const zh: Translations = {
  ...
  messaging: {
    ...
    emailContent: '邮件内容',
    richHtmlEmail: '富文本 HTML 邮件',
    richHtmlEmailHelp: '将发出的 Markdown 渲染为经过清理的 HTML，并保留纯文本备用内容。',
    emailSignature: '签名',
    emailSignatureHelp: '在每封发出的邮件中仅追加一次配置的签名。',
    emailSignatureText: '签名文本',
    emailSignatureTextHelp: '规范的纯文本备用内容。启用签名时必填。',
    emailSignatureTextPlaceholder: '输入纯文本签名',
    emailSignatureTextRequired: '启用签名时必须填写签名文本。',
    emailSignatureHtml: '高级签名 HTML',
    emailSignatureHtmlHelp: '可选的已清理 HTML。留空时将根据签名文本生成。',
    emailSignatureHtmlPlaceholder: '<strong>可选 HTML 签名</strong>',
    emailSignatureLogo: '签名徽标',
    emailSignatureLogoHelp: '仅当富 HTML 邮件和签名均已启用，且签名 HTML 包含 {{email_signature_logo}} 时使用。',
    emailSignatureLogoFormats: 'PNG、JPEG、GIF 或 WebP。最大大小：2 MiB。',
    emailSignatureLogoLoading: '正在加载签名徽标…',
    emailSignatureLogoNone: '未配置签名徽标。',
    emailSignatureLogoConfigured: '已配置签名徽标。',
    emailSignatureLogoInvalidStored: '已配置的签名徽标无效。请替换或移除。',
    emailSignatureLogoFile: '签名徽标文件',
    emailSignatureLogoChoose: '选择徽标',
    emailSignatureLogoReplace: '替换徽标',
    emailSignatureLogoUploading: '正在上传…',
    emailSignatureLogoUploaded: '签名徽标已上传。',
    emailSignatureLogoRemove: '移除徽标',
    emailSignatureLogoRemoving: '正在移除…',
    emailSignatureLogoRemoved: '签名徽标已移除。',
    emailSignatureLogoRemoveTitle: '移除签名徽标',
    emailSignatureLogoRemoveDescription: '这将从此配置文件中移除徽标。签名文本和 HTML 不会更改。',
    emailSignatureLogoUnsupported: '签名徽标需要更新版本的 Hermes 后端。',
    emailSignatureLogoTooLarge: '徽标大小不得超过 2 MiB。',
    emailSignatureLogoInvalidType: '请选择 PNG、JPEG、GIF 或 WebP 图像。',
    emailSignatureLogoBackendInvalid: '后端拒绝了此图像。请选择有效的 PNG、JPEG、GIF 或 WebP 文件。',
    emailSignatureLogoProfileNotFound: '找不到所选配置文件。',
    emailSignatureLogoRemoteUploadUnsupported: '暂不支持向受 OAuth 保护的远程后端上传文件。',
    emailSignatureLogoFailed: '无法更新签名徽标。',
    emailPreview: '邮件预览',
    emailPreviewHelp: '使用当前未保存的 HTML 和签名设置生成安全预览。',
    emailPreviewBody: '示例消息',
    emailPreviewBodyHelp: '输入要预览的 Markdown。不会发送任何内容。',
    emailPreviewBodyDefault: '**你好**。\n\n这是邮件预览。',
    emailPreviewGenerate: '生成预览',
    emailPreviewGenerating: '正在生成…',
    emailPreviewUnsupported: '邮件预览需要更新版本的 Hermes 后端。',
    emailPreviewFailed: '无法生成邮件预览。',
    emailPreviewFrameTitle: '已渲染的邮件预览',
    emailPreviewPlainFallback: '纯文本备用内容',
    enabled: '已启用',
    disabled: '已禁用',

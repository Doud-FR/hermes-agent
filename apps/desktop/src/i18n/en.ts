...
export const en: Translations = {
  ...
  messaging: {
    ...
    richHtmlEmail: 'Rich HTML email',
    richHtmlEmailHelp: 'Render outgoing Markdown as sanitized HTML with a plain-text fallback.',
    emailSignature: 'Signature',
    emailSignatureHelp: 'Append the configured signature once to every outgoing email.',
    emailSignatureText: 'Signature text',
    emailSignatureTextHelp: 'Canonical plain-text fallback. Required when the signature is enabled.',
    emailSignatureTextPlaceholder: 'Enter the plain-text signature',
    emailSignatureTextRequired: 'Signature text is required when the signature is enabled.',
    emailSignatureHtml: 'Advanced signature HTML',
    emailSignatureHtmlHelp: 'Optional sanitized HTML. Leave blank to generate it from the signature text.',
    emailSignatureHtmlPlaceholder: '<strong>Optional HTML signature</strong>',
    emailSignatureLogo: 'Signature logo',
    emailSignatureLogoHelp:
      'Used only when rich HTML email and the signature are enabled, and the signature HTML contains {{email_signature_logo}}.',
    emailSignatureLogoFormats: 'PNG, JPEG, GIF, or WebP. Maximum size: 2 MiB.',
    emailSignatureLogoLoading: 'Loading signature logo…',
    emailSignatureLogoNone: 'No signature logo configured.',
    emailSignatureLogoConfigured: 'Signature logo configured.',
    emailSignatureLogoInvalidStored: 'The configured signature logo is invalid. Replace or remove it.',
    emailSignatureLogoFile: 'Signature logo file',
    emailSignatureLogoChoose: 'Choose logo',
    emailSignatureLogoReplace: 'Replace logo',
    emailSignatureLogoUploading: 'Uploading…',
    emailSignatureLogoUploaded: 'Signature logo uploaded.',
    emailSignatureLogoRemove: 'Remove logo',
    emailSignatureLogoRemoving: 'Removing…',
    emailSignatureLogoRemoved: 'Signature logo removed.',
    emailSignatureLogoRemoveTitle: 'Remove signature logo',
    emailSignatureLogoRemoveDescription:
      'This removes the logo from this profile. The signature text and HTML are not changed.',
    emailSignatureLogoUnsupported: 'Signature logos require a newer Hermes backend.',
    emailSignatureLogoTooLarge: 'The logo must be 2 MiB or smaller.',
    emailSignatureLogoInvalidType: 'Choose a PNG, JPEG, GIF, or WebP image.',
    emailSignatureLogoBackendInvalid: 'The backend rejected this image. Choose a valid PNG, JPEG, GIF, or WebP file.',
    emailSignatureLogoProfileNotFound: 'The selected profile was not found.',
    emailSignatureLogoRemoteUploadUnsupported:
      'File uploads are not supported against OAuth-gated remote backends yet.',
    emailSignatureLogoFailed: 'Could not update the signature logo.',
    emailPreview: 'Email preview',
    emailPreviewHelp: 'Render a safe preview using the current unsaved HTML and signature settings.',
    emailPreviewBody: 'Sample message',
    emailPreviewBodyHelp: 'Enter Markdown to preview. Nothing is sent.',
    emailPreviewBodyDefault: 'Hello **there**.\n\nThis is an Email preview.',
    emailPreviewGenerate: 'Generate preview',
    emailPreviewGenerating: 'Generating…',
    emailPreviewUnsupported: 'Email preview requires a newer Hermes backend.',
    emailPreviewFailed: 'Could not generate the Email preview.',
    emailPreviewFrameTitle: 'Rendered Email preview',
    emailPreviewPlainFallback: 'Plain-text fallback',
    enabled: 'Enabled',
    disabled: 'Disabled',

...
export const ja = defineLocale({
  ...
  messaging: {
    ...
    emailContent: 'メール本文',
    richHtmlEmail: 'リッチ HTML メール',
    richHtmlEmailHelp: '送信する Markdown を安全な HTML に変換し、プレーンテキスト版も添付します。',
    emailSignature: '署名',
    emailSignatureHelp: '設定した署名を各送信メールに一度だけ追加します。',
    emailSignatureText: '署名テキスト',
    emailSignatureTextHelp: '標準のプレーンテキスト版です。署名を有効にする場合は必須です。',
    emailSignatureTextPlaceholder: 'プレーンテキストの署名を入力',
    emailSignatureTextRequired: '署名を有効にする場合は署名テキストが必要です。',
    emailSignatureHtml: '高度な署名 HTML',
    emailSignatureHtmlHelp: '任意の安全化された HTML です。空欄の場合は署名テキストから生成されます。',
    emailSignatureHtmlPlaceholder: '<strong>任意の HTML 署名</strong>',
    emailSignatureLogo: '署名ロゴ',
    emailSignatureLogoHelp:
      'リッチ HTML メールと署名が有効で、署名 HTML に {{email_signature_logo}} が含まれる場合にのみ使用されます。',
    emailSignatureLogoFormats: 'PNG、JPEG、GIF、WebP。最大サイズ: 2 MiB。',
    emailSignatureLogoLoading: '署名ロゴを読み込んでいます…',
    emailSignatureLogoNone: '署名ロゴは設定されていません。',
    emailSignatureLogoConfigured: '署名ロゴが設定されています。',
    emailSignatureLogoInvalidStored: '設定済みの署名ロゴが無効です。置換または削除してください。',
    emailSignatureLogoFile: '署名ロゴファイル',
    emailSignatureLogoChoose: 'ロゴを選択',
    emailSignatureLogoReplace: 'ロゴを置換',
    emailSignatureLogoUploading: 'アップロード中…',
    emailSignatureLogoUploaded: '署名ロゴをアップロードしました。',
    emailSignatureLogoRemove: 'ロゴを削除',
    emailSignatureLogoRemoving: '削除中…',
    emailSignatureLogoRemoved: '署名ロゴを削除しました。',
    emailSignatureLogoRemoveTitle: '署名ロゴを削除',
    emailSignatureLogoRemoveDescription: 'このプロファイルからロゴを削除します。署名テキストと HTML は変更されません。',
    emailSignatureLogoUnsupported: '署名ロゴを使用するには、より新しい Hermes バックエンドが必要です。',
    emailSignatureLogoTooLarge: 'ロゴは 2 MiB 以下にしてください。',
    emailSignatureLogoInvalidType: 'PNG、JPEG、GIF、または WebP 画像を選択してください。',
    emailSignatureLogoBackendInvalid:
      'バックエンドがこの画像を拒否しました。有効な PNG、JPEG、GIF、または WebP ファイルを選択してください。',
    emailSignatureLogoProfileNotFound: '選択したプロファイルが見つかりません。',
    emailSignatureLogoRemoteUploadUnsupported:
      'OAuth で保護されたリモートバックエンドへのファイルアップロードは未対応です。',
    emailSignatureLogoFailed: '署名ロゴを更新できませんでした。',
    emailPreview: 'メールプレビュー',
    emailPreviewHelp: '現在の未保存の HTML と署名設定を使用して、安全なプレビューを表示します。',
    emailPreviewBody: 'サンプルメッセージ',
    emailPreviewBodyHelp: 'プレビューする Markdown を入力します。メールは送信されません。',
    emailPreviewBodyDefault: '**こんにちは**。\n\nこれはメールのプレビューです。',
    emailPreviewGenerate: 'プレビューを生成',
    emailPreviewGenerating: '生成中…',
    emailPreviewUnsupported: 'メールプレビューには新しい Hermes バックエンドが必要です。',
    emailPreviewFailed: 'メールプレビューを生成できませんでした。',
    emailPreviewFrameTitle: 'レンダリングされたメールプレビュー',
    emailPreviewPlainFallback: 'プレーンテキスト版',
    enabled: '有効',
    disabled: '無効',
